															...
															<?php else: ?>
																<td>
																	<ul>
																		...
																		<li><strong><?php _e('Slug', JCF_TEXTDOMAIN); ?></strong>: <em><?php echo $field_settings[$key][$field_id]['slug']; ?></em></li>
																		<li><strong><?php _e('Enabled', JCF_TEXTDOMAIN); ?></strong>: <em><?php if($field_settings[$key][$field_id]['enabled']) _e('Yes', JCF_TEXTDOMAIN); else  _e('No', JCF_TEXTDOMAIN);?></em></li>
																	</ul>
																</td>
																<td colspan="3" >
