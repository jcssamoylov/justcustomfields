		...
		<form action="<?php get_permalink(); ?>" id="jcform_settings" method="post" class="jcf_form_horiz" onsubmit="return initSettings();">
			...
			<div class="card pressthis">
				...
				<label for="jcf_read_file">
					<?php _e('<b>File system: Current theme folder</b>. Fields configuration is saved to the current theme folder in json format and can be copied to another site easily.' , \jcf\JustCustomFields::TEXTDOMAIN); ?>
				</label><br />
				...
				<label for="jcf_read_file_global" <?php if ( !$show_fs_global ) echo 'style="display:none;"'; ?>>
					<?php _e('<b>File system: Global</b> (/wp-content/jcf-settings/*). Fields configuration is saved to the wp-content folder in json format and can be copied to another site easily.' , \jcf\JustCustomFields::TEXTDOMAIN); ?>
				</label><br />
			</div>
			<br /><br />
