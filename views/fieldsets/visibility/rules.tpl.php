<div class="rules">
		...
		<table class="wp-list-table widefat fixed fieldset-visibility-rules">
			<thead>
				<tr>
					...
					<th><?php _e('Rule', \jcf\JustCustomFields::TEXTDOMAIN); ?></th>
					<th style="width: 20%;"><?php _e('Options', \jcf\JustCustomFields::TEXTDOMAIN); ?></th>
				</tr>
			</thead>
			<tbody>
	...
	<?php endif; ?>
	<p><input type="button" class="add_rule_btn button" name="add_rule" value="<?php _e('Add rule', \jcf\JustCustomFields::TEXTDOMAIN); ?>"/></p>
</div>
