			...
			<form action="<?php get_permalink(); ?>" id="jcform_settings" method="post" class="jcf_form_horiz" onsubmit="return initSettings();">
					...
					<div class="card pressthis">
						...
						<fieldset>
							<input type="radio" name="jcf_multisite_setting" id="jcf_setting_global" 
								   value="<?php echo JCF_CONF_MS_NETWORK; ?>" <?php checked($this->settings->network, JCF_CONF_MS_NETWORK); ?> />
							...
							<input type="radio" name="jcf_multisite_setting" id="jcf_setting_each" 
								   value="<?php echo JCF_CONF_MS_SITE; ?>" <?php checked($this->settings->network, JCF_CONF_MS_SITE); ?> />
				...
				<div class="card pressthis">
					...
					<input type="radio" class="jcf_choose_settings" name="jcf_read_settings" 
						   value="<?php echo JCF_CONF_SOURCE_DB; ?>" id="jcf_read_db" <?php checked($this->settings->source, JCF_CONF_SOURCE_DB); ?>/>
					...
					<input type="radio" rel="" class="jcf_choose_settings" name="jcf_read_settings" 
						   value="<?php echo JCF_CONF_SOURCE_FS_THEME; ?>" id="jcf_read_file"  <?php checked($this->settings->source, JCF_CONF_SOURCE_FS_THEME); ?>/>
					...
					<?php $show_fs_global = MULTISITE && $this->settings->network == JCF_CONF_MS_NETWORK; ?>
					<input type="radio" rel="" <?php if(!$show_fs_global) echo 'style="display:none;"'; ?> 
						   class="jcf_choose_settings" name="jcf_read_settings" 
						   value="<?php echo JCF_CONF_SOURCE_FS_GLOBAL; ?>" id="jcf_read_file_global"  <?php checked($this->settings->source, JCF_CONF_SOURCE_FS_GLOBAL); ?>/>
