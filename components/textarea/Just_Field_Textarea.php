...
class Just_Field_Textarea extends models\Just_Field
{
	...
	public function __construct()
	{
		...
		parent::__construct('textarea', __('Textarea', \jcf\JustCustomFields::TEXTDOMAIN), $field_ops);
	}
	...
	public function form()
	{
		...
		<p><label for="<?php echo $this->getFieldId('editor'); ?>"><input class="checkbox" id="<?php echo $this->getFieldId('editor'); ?>" name="<?php echo $this->getFieldName('editor'); ?>" type="checkbox" value="1" <?php echo $checked; ?> /> <?php _e('Use Editor for this textarea:', \jcf\JustCustomFields::TEXTDOMAIN); ?></label></p>
